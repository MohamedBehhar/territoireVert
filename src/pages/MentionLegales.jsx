    ...
    <div className='mention container'>
      ...
      <table>
          ...
          <tr>
            ...
            <td>
              <span>Intelead SARL </span>au capital de 100 000 dhs <br /> <br />
              Inscrite au de numéro de registre de commerce 426503 <br />
              Siège social : Angle Boulevard Emile ZOLA Et rue Rethel 11ème étage N29 – Casablanca, Maroc <br /> <br />
              Directeur de la publication M. Akram OUGRI <br /> <br />
              Numéro ICE: 002228395000010
            </td>
          </tr>
          <br />
        </table>
      ...
      <section>
        ...
        <p>
          L’Utilisateur accède au site Territoirevert.com (ci-après « le Site) par l’intermédiaire des réseaux de communication de l’Internet. L’Utilisateur déclare en connaître les risques et les accepter. Il reconnaît notamment que les informations qui y transitent ou y sont stockées peuvent être interceptées ou altérées contre la volonté de Intelead . Il relève de la responsabilité de l’Utilisateur de prendre toutes les précautions nécessaires afin de se prémunir contre les effets de la piraterie, notamment en adoptant une configuration informatique sécurisée et adaptée, par la mise en place d’un logiciel de détection de virus régulièrement mis à jour. Intelead ne pourra en aucun cas être tenue pour responsable en cas de contamination du matériel informatique de l’Utilisateur au cours ou après la navigation de celui-ci sur le site Internet Territoirevert.com. De plus, Intelead ne saurait être tenue pour responsable de la mauvaise utilisation des informations ou services par l’Utilisateur. Par ailleurs, Intelead décline toute responsabilité relative à une quelconque décision prise par l’Utilisateur sur la base des seuls contenus publiés sur le site ou dans les réponses aux demandes de contact. En outre, Intelead  veille à garantir l’exactitude des informations présentes sur son site. Néanmoins, il est expressément précisé que les informations traitées peuvent contenir des inexactitudes techniques ou typographiques, des omissions, etc. Il est précisé que Intelead  ne peut en aucune façon être tenue pour responsable des erreurs éventuelles présentes sur son site, de la complétude des informations traitées, ni d’une absence de disponibilité des informations. En tout état de cause, la responsabilité de Intelead ne saurait être recherchée en cas de conséquences ou de dommages, de toute nature, liés à la communication par l’Utilisateur à Intelead  d’informations inexactes, incomplètes ou obsolètes Intelead  remercie les Utilisateurs du présent site de lui faire part d’éventuelles omissions, erreurs ou corrections, en adressant un courrier électronique au webmestre du site à l’adresse suivante : [adresse de contact]. L’Utilisateur reconnaît que Intelead se réserve le droit de modifier, d’interrompre temporairement ou de façon permanente tout ou partie du site, sans préavis. Intelead  ne pourra voir sa responsabilité recherchée en cas d’indisponibilité temporaire, partielle ou totale du, du site notamment en cas de maintenance du site ou du serveur sur lequel il est hébergé, en cas d’incident technique et plus généralement en cas d’évènement extérieur à son contrôle.
        </p>
        <br />
        <h2>3. droits de propriété intellectuelle</h2>
        <p>
        La société Intelead , au capital de 100 000 dhs Inscrite au de numéro de registre de commerce 426503 et dont le Siège social est situé à Angle Boulevard Emile ZOLA Et rue Rethel 11ème étage N29 – Casablanca, Maroc, est responsable de traitement pour les données personnelles (ci-après dénommées les « Données ») collectées auprès de l’Utilisateur du site internet Territoirevert.com (ci-après dénommé « l’Utilisateur »). <br />
        ...
        la gestion des relations de Intelead avec les Utilisateurs du site, et avec ses contacts (clients/prospects) de manière générale, en ce incluant les opérations de communication et de marketing (notamment segmentation, ciblage, prospection, newsletter) ; <br />
        ...
        le respect des obligations légales et réglementaires résultant notamment de l’activité de Intelead. <br />
        Les finalités de ces traitements résultent principalement de l’intérêt légitime de Intelead à suivre, gérer et organiser ses relations, notamment commerciales, avec les Utilisateurs du site et plus généralement avec ses contacts, et de l’organisation d’opérations de marketing et de communication de manière générale.
        </p>
        <br />
        <p>
